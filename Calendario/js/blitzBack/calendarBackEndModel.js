...
calendarBackEndApp.service('calendarBackEndModel', function ($http, $q) {
    ...
    function getListaEventos() {
        var request = $http({
            method: 'POST', url: "ServiciosWeb/CalendarService.asmx/GetListaEventosBlitz", contentType: 'application/json; charset=utf-8', data: { data: 'key' }
        });
        return (request.then(handleSuccess, handleError));
    }

    function submitBlitz(datae) {
        var request = $http({
            method: 'POST', url: "ServiciosWeb/CalendarService.asmx/SubmitBlitz", contentType: 'application/json; charset=utf-8', data: { 'blitz': datae }
        });
        return (request.then(handleSuccess, handleError));
    }
    ...
    function deleteEvent(eventId) {
        var request = $http({
            method: 'POST', url: "ServiciosWeb/CalendarService.asmx/DeleteEventBlitz", contentType: 'application/json; charset=utf-8', data: { 'eventId': eventId }
        });
        return (request.then(handleSuccess, handleError));
    }
    ...
    function getEventById(eventId) {
        var request = $http({
            method: 'POST', url: "ServiciosWeb/CalendarService.asmx/GetEventById", contentType: 'application/json; charset=utf-8', data: { 'eventId': eventId }
        });
        return (request.then(handleSuccess, handleError));
    }
