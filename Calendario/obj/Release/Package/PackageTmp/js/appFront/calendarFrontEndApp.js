    ...
    var calendarFrontEndApp = angular.module('calendarFrontEndApp', ['ngRoute', 'ngSanitize', 'AngularPrint']);
    ...
    calendarFrontEndApp.factory('getJson', function ($http) {
        return {
    ...
    calendarFrontEndApp.directive('convertToNumber', function () {
        return {
            require: 'ngModel',
    ...
    calendarFrontEndApp.filter('searchFor', function () {
    ...
    calendarFrontEndApp.filter("commaBreak", function () {
    ...
    calendarFrontEndApp.directive('pleaseWaitDialog', function () {
        return {
            restrict: 'A',
    ...
    calendarFrontEndApp.filter('cmdate', [
    ...
    calendarFrontEndApp.filter('cmQ', [
        '$filter', function ($filter) {
    ...
    calendarFrontEndApp.config(function ($routeProvider) {


        $routeProvider
            .when('/', {
                templateUrl: 'views/frontEnd/calendar.html',
